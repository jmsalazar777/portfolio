...
function wp5default_customize_register( $wp_customize ) {
	...
	// phone number label
	$wp_customize->add_setting( 'phone-label', array(
		'default' => null,
		'sanitize_callback' => 'wp5default_sanitize_text'
	) );
	$wp_customize->add_control( 'phone-label', array(
		'label'		=> __( 'Phone Number Label', 'wp5default' ),
		'section'	=> 'general_section',
	...
	// Email address label
	$wp_customize->add_setting( 'email-label', array(
		'default' => null,
		'sanitize_callback' => 'wp5default_sanitize_text'
	) );
	$wp_customize->add_control( 'email-label', array(
		'label'		=> __( 'Email Address Label', 'wp5default' ),
		'section'	=> 'general_section',
	...
	$wp_customize->add_setting( 'address_icon', array( 'default' => null ) );
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'address_icon', array(
		'label'		=> __( 'Address Icon', 'wp5default' ),
		'section'	=> 'general_section',
	...
	$wp_customize->add_setting( 'address-label', array(
		'default' => null,
		'sanitize_callback' => 'wp5default_sanitize_text'
	) );
	$wp_customize->add_control( 'address-label', array(
		'label'		=> __( 'Location Address Label', 'wp5default' ),
		'section'	=> 'general_section',
	...
	$wp_customize->add_control( new wp5default_Customize_Textarea_Control( $wp_customize, 'banner_content', array(
		'label'		=> __( 'Banner Content', 'wp5default' ),
		'section'	=> 'banner_section',
	...
	$wp_customize->add_setting( 'button_caption', array(
		'default' => null,
		'sanitize_callback' => 'wp5default_sanitize_text'
	) );
	$wp_customize->add_control( 'button_caption', array(
		'label'		=> __( 'Banner Button Caption', 'wp5default' ),
		'section'	=> 'banner_section',
		'settings'	=> 'button_caption',
		'priority'	=> 30,
	) );

	// Banner Button Caption Link
	$wp_customize->add_setting( 'button_caption_link', array(
		'default' => null,
		'sanitize_callback' => 'wp5default_sanitize_text'
	) );
	$wp_customize->add_control( 'button_caption_link', array(
		'label'		=> __( 'Banner Button Caption Link', 'wp5default' ),
		'section'	=> 'banner_section',
		'settings'	=> 'button_caption_link',
		'priority'	=> 31,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'payment_cards', array(
		'label'		=> __( 'Payment Cards', 'wp5default' ),
		'section'	=> 'footer_section',
